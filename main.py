...
class kivy_box(MDApp):
    ...
    def on_start(self):
        ...
        #print(dir(self.manager_screens.current))
        for i in range(30):
            self.manager_screens.get_screen('first screen').ids.scroll.add_widget(
                Button(text=f"Item {i}",
                      pos_hint={"center_x": 0.5, "center_y": 0.5},
                      size_hint=(None, None),
                      size=(dp(310), dp(45)),
                      on_press=self.listbutton)
            )
